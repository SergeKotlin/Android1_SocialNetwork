...
//    private final boolean[] chosenMulti = {false, false, false}; // Здесь будет храниться информация для мульти-списка
    ...
    private Button fragmentBuilderButton;
    private Button fragmentCustomButton;
...
//        initView();
        initView2();
//        initResource();
            //TODO Потренить-напомнить, сделать переключаемые View для AlertDialogs и FragmentDialog
            // Простейшее - как в HW7, кнопки на фрагменте для заметки.. ну и самое простое -
            // - управление видимостью двух LinearLayouts (в конце лекции)
//        toControlAlerts();
        toControlAlerts2();
...
//    }
    ...
    private void initView2() {
        fragmentBuilderButton = findViewById(R.id.dialogBuilder);
        fragmentCustomButton = findViewById(R.id.dialogCustom);
    }

    private void toControlAlerts2() {
